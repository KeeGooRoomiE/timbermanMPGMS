...
for (i=0; i<arrL; i++)
{
	...
	//draw_text( x-1,y-(cellY/2)-(cellY*i),"I: "+string(treearr[i]+ "|"+treebrarr[ii]+"|"+treecellar[i]) );
...
draw_text_ext_transformed_color(x,y-96,string(playerScore),24,108,xsc,xsc,0,c_white,c_white,c_white,c_white,1);
#endregion
